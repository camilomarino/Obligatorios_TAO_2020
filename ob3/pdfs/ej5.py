...
#practicamente igual al anterior pero con restriccion de mu>=0
# ademas devolvemos el signo de la variable
def resolverPA(P0, Q0, R0, n):
    ...
    func = t
    restricciones = [mu>=0, X>=0, X == cp.bmat([[P, Q], [Q.T, cp.diag(R - t)]])]
...
print('valor problema PA  PA* = %s' % (xPA))
